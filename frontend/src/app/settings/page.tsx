      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 md:py-16 space-y-10 text-sm font-sans">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[var(--line)]">
          <div className="space-y-1">
            <h1 className="text-3xl font-semibold tracking-tight text-[var(--text-0)]">
              Account & Ledger Settings
            </h1>
            <p className="text-[var(--text-1)] text-xs sm:text-sm">
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <section className="p-6 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--card)]/40 space-y-5">
            <div className="flex items-center gap-2 text-base font-semibold text-[var(--text-0)] pb-2 border-b border-[var(--line)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="settings-full-name" className="block text-xs font-mono text-[var(--text-1)] mb-1 font-medium">
                  Full Name *
                </label>
                <input
                  ...
                  className="w-full px-3 py-2 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--ink-0)] text-[var(--text-0)] focus:border-emerald-500 outline-none text-xs"
                />
                {errors.name && (
              ...
              <div>
                <label htmlFor="settings-handle" className="block text-[11px] uppercase tracking-wider text-[var(--text-1)] mb-1 font-semibold">
                ...
                <input
                  ...
                  disabled
                  value={`@${user.username}`}
                  className="w-full px-3 py-2 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--card)] text-[var(--text-1)] cursor-not-allowed font-mono text-xs"
                />
              </div>
            </div>

            <div>
              <label htmlFor="settings-headline" className="block text-[11px] uppercase tracking-wider text-[var(--text-1)] mb-1 font-semibold">
                Headline *
              </label>
              <input
            ...
            <div>
              <label htmlFor="settings-bio" className="block text-[11px] uppercase tracking-wider text-[var(--text-1)] mb-1 font-semibold">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--ink-0)] text-[var(--text-0)] focus:border-emerald-500 outline-none text-xs leading-relaxed"
              />
              {errors.bio && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div>
                <label htmlFor="settings-avatar-url" className="block text-xs font-mono text-[var(--text-1)] mb-1 font-medium flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--ink-0)] text-[var(--text-0)] focus:border-emerald-500 outline-none text-xs font-mono"
                  />
                  {avatarUrl ? (
                    <div className="relative w-8 h-8 rounded-full border border-[var(--line)] shrink-0 overflow-hidden">
                      <Image
                        src={avatarUrl}
                        alt="Avatar preview"
                        fill
              ...
              <div>
                <label htmlFor="settings-github-url" className="block text-xs font-mono text-[var(--text-1)] mb-1 font-medium flex items-center gap-1.5">
            ...
            <div>
              <label htmlFor="settings-email" className="block text-xs font-mono text-[var(--text-1)] mb-1 font-medium flex items-center gap-1.5">
          ...
          <section className="p-6 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--card)]/40 space-y-4">
            <div className="flex items-center gap-2 text-base font-semibold text-[var(--text-0)] pb-2 border-b border-[var(--line)]">
              ...
              {POPULAR_SKILLS.map((skill) => {
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1 rounded-[var(--radius)] border text-xs cursor-pointer transition-colors font-mono ${
                      active
                        ? 'border-emerald-500 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 font-semibold'
                        : 'border-[var(--line)] bg-[var(--card)] text-[var(--text-1)] hover:text-[var(--text-0)]'
                    }`}
                  >
                    {active ? '✓ ' : '+ '}
                    {skill}
          ...
          <section className="p-6 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--card)] space-y-4">
            <div className="flex items-center gap-2 text-base font-semibold text-[var(--text-0)] pb-2 border-b border-[var(--line)]">
            ...
            <div role="radiogroup" aria-label="AI compute model tier" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div
                ...
                className={`p-4 rounded-[var(--radius)] border cursor-pointer transition-colors space-y-2 ${
                  plan === 'byok'
                    ? 'border-emerald-500 bg-[var(--ink-0)]'
                    : 'border-[var(--line)] bg-[var(--card)]/60'
                }`}
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[var(--text-0)] text-sm">BYOK Plan</span>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[var(--text-0)] text-sm">Full-Service</span>
                  <span className="text-xs text-emerald-700 dark:text-emerald-400 uppercase font-mono font-semibold">
                    ~₦5,000 / mo
                  </span>
                </div>
            ...
            {plan === 'byok' && (
              <div className="space-y-2 pt-2">
                <label htmlFor="settings-api-key" className="block text-xs uppercase tracking-wider text-[var(--text-1)] font-semibold font-mono">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--ink-0)] text-[var(--text-0)] focus:border-emerald-500 outline-none font-mono text-xs"
                />
                <span className="text-[10.5px] text-[var(--text-1)] block font-mono">
          ...
          <section className="p-6 rounded-[var(--radius)] border border-[var(--line)] bg-[var(--card)]/40 space-y-3">
            <div className="flex items-center justify-between pb-2 border-b border-[var(--line)]">
              <div className="flex items-center gap-2 text-base font-semibold text-[var(--text-0)]">
                <CreditCard className="w-4 h-4 text-[var(--text-1)]" aria-hidden="true" />
            ...
            <div className="flex items-center justify-between text-xs text-[var(--text-1)] font-mono">
