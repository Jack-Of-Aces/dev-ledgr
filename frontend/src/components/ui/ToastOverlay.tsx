...
export const ToastOverlay: React.FC = () => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-6 right-6 z-50 max-w-md w-full p-4 bg-card border border-line rounded-radius shadow-lg transition-all animate-in fade-in duration-300"
    >
